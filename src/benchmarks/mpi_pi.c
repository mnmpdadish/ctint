// code found on the internet at the adress:
// http://people.sc.fsu.edu/~jburkardt/c_src/mpi/monte_carlo_mpi.c
// i don't own this code, but keep it there as an example
...
*/
    sran ( (int)(time.tv_usec*1000000+time.tv_sec) );
# endif
    do
    {
